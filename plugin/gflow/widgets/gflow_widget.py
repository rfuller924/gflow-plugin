...
class GflowWidget(QWidget):
    def __init__(self, parent, iface):
        ...
        self.config_button = QPushButton("Configure GFLOW")
        self.config_button.clicked.connect(self.config_dialog.show)
    ...
    def enable_geopackage_buttons(self) -> None:
        ...
        self.dataset_widget.gflow_convert_button.setEnabled(True)
